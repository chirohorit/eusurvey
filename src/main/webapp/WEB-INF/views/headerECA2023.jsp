...
<%@ taglib prefix="esapi"
	uri="https://www.owasp.org/index.php/Category:OWASP_Enterprise_Security_API"%>

<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>

<div id="pathheader" style="background-color: #F5F5F5">
	<div class="lang-en" id="header">
		...
		<div id="logo_text">
			<div class="logo_title">${form.getMessage("eca.EUROPEANCOURTOFAUDITORS")}</div>
			<br>
			<div class="logo_slogan">${form.getMessage("eca.GuardiansOfTheEUfinances")}</div>
		</div>
	</div>
</div>
