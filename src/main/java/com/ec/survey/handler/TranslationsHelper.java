...
public class TranslationsHelper {
	...
	private static final Logger logger = LoggerFactory.getLogger(TranslationsHelper.class);
	...
	private static String getText(Sheet sheet, int row, int cell, String key, List<String> invalidKeys,
		...
		try {
			...
			if (String.valueOf(sCell.getCellType()).equals(String.valueOf(CellType.NUMERIC))) {
