...
public class SystemController extends BasicController {
	...
	public @ResponseBody Message getSystemMessage(HttpServletRequest request)
		...
		boolean runnermode = request.getParameter("runnermode") != null
	...
	public @ResponseBody String deleteMessage(HttpServletRequest request)
		...
		if (sid != null) {
			...
			systemService.deleteMessage(id, user.getId(),
					user.getGlobalPrivileges().get(GlobalPrivilege.SystemManagement) > 0);
		}
	...
	public ModelAndView getSystemMessagesRunner(HttpServletRequest request)
			throws NotAgreedToTosException, WeakAuthenticationException, NotAgreedToPsException {
		return getSystemMessages(request, true);
	}

	@RequestMapping(value = "/messages", method = { RequestMethod.GET, RequestMethod.HEAD })
	public ModelAndView getSystemMessages(HttpServletRequest request)
			throws NotAgreedToTosException, WeakAuthenticationException, NotAgreedToPsException {
		return getSystemMessages(request, false);
	}

	private ModelAndView getSystemMessages(HttpServletRequest request, boolean runnermode)
			throws NotAgreedToTosException, WeakAuthenticationException, NotAgreedToPsException {
	...
	@PostMapping(value = "/configureLogging")
	...
	@PostMapping(value = "/configureMessage")
	public ModelAndView configureMessage(@RequestParam("active") String active,
			@RequestParam("autodeactivate") String autodeactivate,
			@RequestParam("autodeactivatetime") String autodeactivatetime, @RequestParam("time") String time,
			@RequestParam("type") String type, @RequestParam("text") String text,
			@RequestParam("criticality") String criticality, HttpServletRequest request, Model model, Locale locale) {
		Message message = systemService.getMessage();
